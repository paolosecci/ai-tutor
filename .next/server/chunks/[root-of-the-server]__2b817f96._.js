module.exports = [
"[project]/.next-internal/server/app/api/pdf/[pdfId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/pdf/[pdfId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    const pdf = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].pdf.findFirst({
        where: {
            id: pdfId,
            userId: user.id
        }
    });
    if (!pdf) return Response.json({
        error: 'PDF not found'
    }, {
        status: 404
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b817f96._.js.map