...
async function GET(req) {
    ...
    if (!session?.user?.email) return new Response('Unauthorized', {
        status: 401
    });
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
        where: {
    ...
    if (!chatId) return new Response('chatId required', {
        status: 400
    });
    const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.findFirst({
        where: {
            id: chatId,
            userId: user.id
        }
    });
    if (!chat) return new Response('Forbidden', {
        status: 403
    });
...
async function POST(req) {
    ...
    if (!chatId || !role || !content) return new Response('Bad request', {
        status: 400
    });
    const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].chat.findFirst({
        where: {
    ...
    const message = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].message.create({
        data: {
            chatId,
            role,
            content
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5f2b5be5._.js.map